...
#ifndef CAMERA_LITE_INTERFACES__SRV__DETAIL__SAVE__FUNCTIONS_H_
#define CAMERA_LITE_INTERFACES__SRV__DETAIL__SAVE__FUNCTIONS_H_
...
#include "camera_lite_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "camera_lite_interfaces/srv/detail/save__struct.h"

/// Initialize srv/Save message.
/**
...
/// Create srv/Save message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_lite_interfaces__srv__Save_Request__init().
...
/// Destroy srv/Save message.
/**
 * It calls
 * camera_lite_interfaces__srv__Save_Request__fini()
...
/// Check for srv/Save message equality.
/**
...
/// Initialize array of srv/Save messages.
/**
...
/// Finalize array of srv/Save messages.
/**
 * It calls
 * camera_lite_interfaces__srv__Save_Request__fini()
...
/// Create array of srv/Save messages.
/**
 * It allocates the memory for the array and calls
 * camera_lite_interfaces__srv__Save_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Save messages.
/**
 * It calls
 * camera_lite_interfaces__srv__Save_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Save message array equality.
/**
...
/// Copy an array of srv/Save messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_lite_interfaces__srv__Save_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_lite_interfaces
...
/**
 * It calls
 * camera_lite_interfaces__srv__Save_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_lite_interfaces
...
/**
 * It allocates the memory for the array and calls
 * camera_lite_interfaces__srv__Save_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_lite_interfaces
...
/**
 * It calls
 * camera_lite_interfaces__srv__Save_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAMERA_LITE_INTERFACES__SRV__DETAIL__SAVE__FUNCTIONS_H_
